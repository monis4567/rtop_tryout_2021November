...
df02$gen_specnm <- gsub("eDNAconc_(.*)_akersvannet.txt","\\1",df02$gen_specnm)
...
#
#getwd()
write.table(df03,"mean_eDNA_conc_Elucius_akersvannet.csv", sep=",",
            dec=".")
...
#p
fnm04 <- "mapplot_eDNA_conc_from_Rcode03_Akersvannet"
